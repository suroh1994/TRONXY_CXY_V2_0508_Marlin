...
#define STRING_CONFIG_H_AUTHOR "(suroh, anet a8 clone)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Winnifre3D, v1.0.1"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 137.19
  #define DEFAULT_bedKi 20.67
  #define DEFAULT_bedKd 606.87
...
#define X_BED_SIZE 220 - 25 // the belt tensioner restricts the movement on the x axis sadly
